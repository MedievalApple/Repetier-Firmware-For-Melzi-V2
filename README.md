...
**Note: if you do not need eeprom support you can use the latest version of repetier ---> https://github.com/repetier/Repetier-Firmware (Just make sure you disable eeprom support or the firmware will be too big to fit on the melzi V2)** 
